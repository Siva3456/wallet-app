...
public class Controller {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Wallet wallet1 = walletService.registerWallet(new Wallet(1, "siva", 1000.0, "146"));
			Wallet wallet2 = walletService.registerWallet(new Wallet(2, "vishal", 5000.0, "456"));
			Wallet wallet3 = walletService.registerWallet(new Wallet(3, "krishna", 3000.0, "srt1"));
			Wallet wallet4 = walletService.registerWallet(new Wallet(4, "abhijith", 8000.0, "12bc"));
